...
import 'package:taskapp/screen/dashboard.dart';
import 'package:taskapp/screen/signup.dart';
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                Text('Task Management App',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.black,),),
                SizedBox(
                  height: 40,
                ),
                SizedBox(
                ...
                Padding(
                  ...
                  }, child: Text("Login",style: TextStyle(color: Colors.black),),style: ElevatedButton.styleFrom(backgroundColor: Colors.lightBlue[200]),),
                ),
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: TextButton(onPressed: (){}, child: Text('Forgot password',style: TextStyle(color: Colors.lightBlue),)),
                ),
                Row(
